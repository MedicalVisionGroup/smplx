...
from smplx.vertex_keypoint_regressor import VerticeKeypointRegressor
...
def batch_chamfer_distance_two_sided_smpl_and_segm(
    ...
    for p_segm_i in p_segm:
        # print("max_n_segm_point: {}".format(max_n_segm_point))
        # print("p_segm_i.shape[0]: {}".format(p_segm_i.shape[0]))
        # print("p_segm_i.shape: {}".format(p_segm_i.shape))
...
def set_smil_model_to_fetal_smpl(model, fetal_smpl_data_dict_path, subj_spec_shape=None):
