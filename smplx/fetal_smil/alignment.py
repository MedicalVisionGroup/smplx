...
import smplx
from smplx.lbs_unpose import unpose_keypoint_vertice
from smplx.vertex_keypoint_regressor import (
    _kpt_name_list,
...
def main_init_align_smil_to_posed_and_unpose(
    exp_data_split_dir,
    exp_result_dir,
    subj_name,
    smil_data_path,
    ...
    # coeff_segm_chamfer = 0
    # coeff_reg_beta = 20
    # coeff_reg_body_pose = 1
